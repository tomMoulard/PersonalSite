...
\cventry{F\fr{év}\en{eb} 2021-date}{\fr{Stagiaire en tant que Développeur Junior}\en{Junior Developer}}{Traefik Labs}{\fr{Télétravail}\en{Remote}}
{}{
    \fr{
        Mainteneur du projet Open Source \href{https://github.com/traefik/traefik}{Traefik Proxy}.
    }
    \en{
        Maintainer of the \href{https://github.com/traefik/traefik}{Traefik Proxy} Open Source Project.
    }
}
