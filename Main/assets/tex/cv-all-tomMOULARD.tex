...
\address{\fr{2 rue Guébriant}\en{2, street guébriant}}{75020 Paris}{\fr{France}}
\phone[mobile]{\href{tel:+33-6-51-48-72-60}{+33 6 51 48 72 60}}
\social[linkedin]{tommoulard}
\social[github]{tommoulard}
\extrainfo{\fr{Permis B - voiture - Proactif en télétravail}\en{Experienced in remote work}}
...
\fr{
    ...
    par un stage dans votre entreprise. Mes capacités en Algorithmique et en
    recherche permettront à votre organisation d'atteindre ses objectifs.
}
\en{
...
{
    \fr{\'Ecole d'ingénieur en informatique}
    \en{Computer Engineering}
}
{FR}
{
    \fr{Membre Prologin et Assistant TCOM}
    \en{Member of the Prologin Association and TCOM assistant}
}{}
\cventry{2014-2019}{UPEC}
{
    \fr{Université d'informatique}
    \en{Computer Engineering focused School}
}
{FR}
{
    \fr{Licence d'informatique}
}{}
\full{\cventry{2018}{Google}{Q{\&}A Meeting with an Google Software Engineer.}{FR}{}{}}
\cventry{2017}{BJTU}{\fr{\'Ecole d'ingénieur en informatique}\en{Computer Engineering}}{ZH}{}{}
\full{\cventry{2014}{BNSSA et PSE1}{lifeguard}{}{}{}}
\cventry{2014}
{
    \fr{Baccalauréat}
...
{}{
    \fr{
        Création d'une application web progressive(PWA) en:
        \begin{itemize}
...
{
    \fr{
        Création d'un site internet utilisant: Go; HTML; CSS; JS et P5.js.
        En utilisant: tests unitaires, tests d'acceptation et du déploiement
        automatique.
    }
    \en{
...
\cventry{\fr{Langages}\en{Languages}}{Python, C, Golang, shell}{}
{Java, C++, C\#, OCamL, JS, SQL}{}{}
\cventry{\fr{Outils}\en{Tools}}{Docker, GIT, CircleCI, Django, Ansible,
Terraform}{}{Docker-compose, Unity, MongoDB, Neo4j, MySQL, PostgreSQL,
VirtualBox, Agouti, Traefik, Apache, Hugo}{}{}
...
\cvitem{Sports}
{
    \fr{Natation, badminton et roller.}
    \en{Swimming; Badminton; Roller.}
}
